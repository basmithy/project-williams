...
namespace Project.F1.Controllers
{
    public class TracksController : Controller
    {
        ...
        public TracksController(DbInitializer context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TrackId,TrackName")] Track track)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TrackId,TrackName")] Track track)
        {
            if (id != track.TrackId)
            {
                return NotFound();
