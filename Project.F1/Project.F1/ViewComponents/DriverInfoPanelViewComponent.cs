...
{
    [ViewComponent(Name = "DriverInfoPanel")]
    public class DriverInfoPanelViewComponent : ViewComponent
    {
        private readonly DbInitializer _context;
        private readonly IPointCalculation _pointCalculation;
        public DriverInfoPanelViewComponent( DbInitializer context, IPointCalculation pointCalculation)
        {
